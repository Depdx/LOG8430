...
docker-compose exec -T mongodb_node_5 sh -c "mongosh < ./scripts/init-shard-5.js"
echo "Initializing node 6"
docker-compose exec -T mongodb_node_6 sh -c "mongosh < ./scripts/init-shard-6.js"
