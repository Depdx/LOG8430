...
export REDIS_NODE_5_ADRESS=$(ping redis_node_5 -c 1 | head -n 1 | cut -d "(" -f 2 | cut -d ")" -f 1)
export REDIS_NODE_5=${REDIS_NODE_5_ADRESS}:${REDIS_NODE_5_PORT}
echo "REDIS_NODE_5: ${REDIS_NODE_5}"

export REDIS_NODE_6_ADRESS=$(ping redis_node_6 -c 1 | head -n 1 | cut -d "(" -f 2 | cut -d ")" -f 1)
export REDIS_NODE_6=${REDIS_NODE_6_ADRESS}:${REDIS_NODE_6_PORT}
echo "REDIS_NODE_6: ${REDIS_NODE_6}"
...
export REDIS_REPLICA_NODE_5_0=$(ping redis_replica_node_5_0 -c 1 | head -n 1 | cut -d "(" -f 2 | cut -d ")" -f 1)
export REDIS_REPLICA_NODE_5_0=${REDIS_REPLICA_NODE_5_0}:${REDIS_REPLICA_NODE_5_0_PORT}
echo "REDIS_REPLICA_NODE_5_0: ${REDIS_REPLICA_NODE_5_0}"

export REDIS_REPLICA_NODE_5_1=$(ping redis_replica_node_5_1 -c 1 | head -n 1 | cut -d "(" -f 2 | cut -d ")" -f 1)
export REDIS_REPLICA_NODE_5_1=${REDIS_REPLICA_NODE_5_1}:${REDIS_REPLICA_NODE_5_1_PORT}
echo "REDIS_REPLICA_NODE_5_1: ${REDIS_REPLICA_NODE_5_1}"

export REDIS_REPLICA_NODE_6_0=$(ping redis_replica_node_6_0 -c 1 | head -n 1 | cut -d "(" -f 2 | cut -d ")" -f 1)
export REDIS_REPLICA_NODE_6_0=${REDIS_REPLICA_NODE_6_0}:${REDIS_REPLICA_NODE_6_0_PORT}
echo "REDIS_REPLICA_NODE_6_0: ${REDIS_REPLICA_NODE_6_0}"

export REDIS_REPLICA_NODE_6_1=$(ping redis_replica_node_6_1 -c 1 | head -n 1 | cut -d "(" -f 2 | cut -d ")" -f 1)
export REDIS_REPLICA_NODE_6_1=${REDIS_REPLICA_NODE_6_1}:${REDIS_REPLICA_NODE_6_1_PORT}
echo "REDIS_REPLICA_NODE_6_1: ${REDIS_REPLICA_NODE_6_1}"
